...
// build/dev/javascript/dict_app/types.mjs
var Model = class extends CustomType {
  constructor(loading, txt, data, is_playing, error_text) {
    super();
...
var Word = class extends CustomType {
  constructor(word, phonetic, meanings, phonetics) {
    super();
    this.word = word;
...
var Phonetic = class extends CustomType {
  constructor(text4, audio2) {
    super();
    this.text = text4;
    this.audio = audio2;
  }
};
var Meaning = class extends CustomType {
  constructor(part_of_speech, synonyms, definitions) {
    super();
...
var Definition = class extends CustomType {
  constructor(def) {
    super();
    this.def = def;
  }
};
var ErrorResponse = class extends CustomType {
  constructor(title, message, resolution) {
    super();
    this.title = title;
    this.message = message;
...
var UserSetText = class extends CustomType {
  constructor(x0) {
    super();
    this[0] = x0;
  }
};
var UserSearch = class extends CustomType {
};
...
var ApiReturnedWord = class extends CustomType {
  constructor(x0) {
    super();
    this[0] = x0;
  }
};
var UserPausedAudio = class extends CustomType {
  constructor(x0) {
    super();
    this[0] = x0;
  }
};
var UserPlayedAudio = class extends CustomType {
  constructor(x0) {
    super();
    this[0] = x0;
  }
};
var UserClickedOnSynonym = class extends CustomType {
  constructor(x0) {
    super();
    this[0] = x0;
  }
};
var AudioEnded = class extends CustomType {
};

// build/dev/javascript/dict_app/api.mjs
function get_word_data(word) {
  let def_decoder = field(
    "definition",
    string2,
    (d) => {
      return success(new Definition(d));
    }
  );
  let meaning_decoder = field(
    "synonyms",
    list2(string2),
    (synonyms) => {
      return field(
        ...
        (p2) => {
          return field(
            ...
            list2(def_decoder),
            (def) => {
              return success(new Meaning(p2, synonyms, def));
            }
          );
        }
      );
  ...
  let phonetics_decoder = optional_field(
    "text",
    "",
    string2,
    (text4) => {
      return field(
        ...
        (audio2) => {
          ...
          if (text4 === "") {
            ...
            _block = new Some(text4);
          }
          let p_text = _block;
          return success(new Phonetic(p_text, audio2));
        }
      );
    }
  );
    ...
    (word2) => {
      return optional_field(
        ...
        (phonetic) => {
          return field(
            "meanings",
            list2(meaning_decoder),
            (meanings) => {
              return field(
                "phonetics",
                list2(phonetics_decoder),
                (phonetics) => {
                  let _block;
                  if (phonetic === "") {
                    _block = new None();
                  } else {
                    _block = new Some(phonetic);
                  }
                  let p2 = _block;
                  return success(new Word(word2, p2, meanings, phonetics));
                }
              );
            }
          );
  ...
  let handler = expect_json(
    list2(decoder),
    (var0) => {
      return new ApiReturnedWord(var0);
    }
  );
  return get2(url, handler);
}
function decode_error(err) {
  let err_decoder = field(
    "title",
    string2,
    (title) => {
      return field(
        ...
        (message) => {
          return field(
            ...
            (resolution) => {
              return success(
                new ErrorResponse(title, message, resolution)
              );
            }
          );
        }
...
// build/dev/javascript/dict_app/components.mjs
function error_display(err) {
  return div(
    toList([]),
    toList([
      (() => {
        if (err instanceof None) {
          return none2();
        } else {
          let e = err[0];
          return text3(e.message);
        }
      })()
    ])
  );
}
function def_view(def) {
  let $ = length2(def);
  if ($ === 0) {
    return none2();
  } else {
    return div(
      ...
      toList([
        p(
          toList([class$("italic")]),
          toList([text3("Meaning")])
        ),
        ul(
          toList([class$("list-disc")]),
          map(
            def,
            (s) => {
              return li(
...
function synonym_view(syn) {
  let $ = length2(syn);
  if ($ === 0) {
    return none2();
  } else {
    return div(
      toList([class$("mt-2 flex gap-2 flex-wrap")]),
      prepend(
        p(
          toList([class$("italic")]),
          toList([text3("Synonyms: ")])
        ),
        map(
          syn,
          (s) => {
              ...
              toList([
                a(
                  toList([
                    ...
                    on_click(new UserClickedOnSynonym(s))
                  ]),
                  toList([text3(s)])
                )
              ])
...
function audio_view(model, phonetics, word) {
  let phonetic = find2(phonetics, (x) => {
    return x.audio !== "";
  });
  if (!phonetic.isOk()) {
    return none2();
    ...
    return div(
      toList([
        class$("flex gap-4 w-full items-center justify-between")
      ]),
      toList([
        div(
          toList([]),
        ...
        div(
          toList([
            ...
            (() => {
              let $ = model.is_playing;
              if (!$) {
                return on_click(new UserPlayedAudio("phonetic-audio"));
              } else {
                return on_click(new UserPausedAudio("phonetic-audio"));
              }
            })()
          ]),
          toList([
            ...
            audio(
              toList([id("phonetic-audio"), src(p2.audio)]),
              toList([])
            )
          ])
        )
...
function word_input(txt) {
  return div(
    toList([
      class$("flex gap-2 my-4 bg-gray-400 rounded-xl py-2 px-3")
    ]),
    toList([
      input(
        toList([
          ...
          value(txt),
          on_input((var0) => {
            return new UserSetText(var0);
          }),
          on_keydown((var0) => {
            return new UserPressedEnter(var0);
          })
        ])
      ),
      button(
        toList([
          on_click(new UserSearch()),
          class$("px-2 text-white-500")
        ]),
        toList([text3("Search")])
      )
    ])
                    ...
                    map(
                      ...
                      (m) => {
                        return div(
                          ...
                          toList([
                            p(
                              toList([class$("italic font-bold")]),
                              toList([text3(m.part_of_speech)])
                            ),
...
function header() {
  return div(
    toList([class$("text-4xl mt-4 text-center text-white-500")]),
    toList([text3("Dictionary App")])
  );
}
function view(model) {
  return div(
    toList([class$("w-responsive container mx-auto h-screen px-2")]),
    toList([
      header(),
...
// build/dev/javascript/dict_app/js_wrapper/index.js
var tryPlayAudio = (elementId, cb) => {
...
// build/dev/javascript/dict_app/dict_app.mjs
function init(_) {
  return [new Model(false, "", new None(), false, new None()), none()];
}
function update2(model, msg) {
  if (msg instanceof UserSetText) {
    let s = msg[0];
    let _block;
    let _pipe = s;
    _block = trim(_pipe);
  ...
  } else if (msg instanceof UserSearch) {
    let $ = string_length(model.txt);
    if ($ === 0) {
      return [model, none()];
    } else {
      return [
  ...
  } else if (msg instanceof ApiReturnedWord && msg[0].isOk()) {
    let data = msg[0][0];
    let $ = first(data);
    if ($.isOk()) {
      let word = $[0];
  ...
  } else if (msg instanceof UserClickedOnSynonym) {
    let str = msg[0];
    return [
      (() => {
        let _record = model;
        return new Model(true, str, new None(), _record.is_playing, new None());
      })(),
      get_word_data(str)
    ];
  ...
  } else if (msg instanceof UserPausedAudio) {
    let str = msg[0];
    let ended_effect = from(
      (send4) => {
        return tryPause(str, () => {
          return send4(new AudioEnded());
        });
      }
    );
    return [
  ...
  } else if (msg instanceof UserPlayedAudio) {
    let str = msg[0];
    let ended_effect = from(
      (send4) => {
        return tryPlayAudio(str, () => {
          return send4(new AudioEnded());
        });
      }
    );
